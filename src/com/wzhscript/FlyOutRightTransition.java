...
public class FlyOutRightTransition extends Transition {


	public FlyOutRightTransition(Activity _act, String folder) {
		super(_act, folder);
		// TODO Auto-generated constructor stub
	}

	public FlyOutRightTransition(Activity _act) {
		super(_act);
		// TODO Auto-generated constructor stub
	}
	...
	protected void generateTransitionImages(String tmpFolder,
		...
		while(GeneralUtils.checkIfFileExistAndNotEmpty(tmpFolder+img1)||GeneralUtils.checkIfFileExistAndNotEmpty(tmpFolder+img2)){
		    ...
		    width1 = width1 == 0 ? 1 : width1;//ensure width2 > 0
//		    width2 = width;
...
//		    bitmap2 = Bitmap.createBitmap(bitmap2, 0, 0, width2, height);
		    ...
		    canvas.drawBitmap(bitmap1, (float)(width - width1), 0f, null);
