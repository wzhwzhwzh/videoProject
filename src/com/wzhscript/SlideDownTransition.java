...
public class SlideDownTransition extends Transition {
	...
	public SlideDownTransition(Activity _act, String folder) {
		super(_act, folder);
		// TODO Auto-generated constructor stub
	}

	public SlideDownTransition(Activity _act) {
		super(_act);
		// TODO Auto-generated constructor stub
	}
	...
	protected void generateTransitionImages(String tmpFolder,
		...
		while(GeneralUtils.checkIfFileExistAndNotEmpty(tmpFolder+img1)||GeneralUtils.checkIfFileExistAndNotEmpty(tmpFolder+img2)){
		    ...
		    canvas.drawBitmap(bitmap1, 0f, (float)height2, null);
		    bitmap2 = Bitmap.createBitmap(bitmap2, 0, height1, width, height2);
