...
public class FlyOutLeftTransition extends Transition {

	public FlyOutLeftTransition(Activity _act, String folder) {
		super(_act, folder);
		// TODO Auto-generated constructor stub
	}

	public FlyOutLeftTransition(Activity _act) {
		super(_act);
		// TODO Auto-generated constructor stub
	}
...
//		    bitmap2 = Bitmap.createBitmap(bitmap2, width - width2, 0, width2, height);
		    ...
		    bitmap1 = Bitmap.createBitmap(bitmap1, width - width1, 0, width1, height);
