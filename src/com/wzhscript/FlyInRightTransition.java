...
public class FlyInRightTransition extends Transition {


	public FlyInRightTransition(Activity _act, String folder) {
		super(_act, folder);
		// TODO Auto-generated constructor stub
	}

	public FlyInRightTransition(Activity _act) {
		super(_act);
		// TODO Auto-generated constructor stub
	}
...
//		    bitmap1 = Bitmap.createBitmap(bitmap1, 0, 0, width1, height);
		    ...
		    canvas.drawBitmap(bitmap2, (float)(width - width2), 0f, null); 
